...
namespace Planning
{
    ...
    public:
        ...
        virtual void vechicle_cartesin_to_frent_2path(const LocalPath &local_path,
                                                      const Referline &refer_line,
                                                      const std::shared_ptr<VehicleBase> &car) = 0; // 定位点在参考线上的投影点参数
    ...
    protected:
        ...
        // 向路径投影的frenet参数
        ToFrenetOutTP to_path_frenet_params_; // 参考线参数
        // 时间参数
